...
# 调用接口获取统计信息
response=$(curl -s "https://tj.bt.sy/api/count?param=aapanel&token=6920626369b1f05844f5e3d6f93b5f6e")
# 检查 Python 版本
...
# 调用接口获取广告信息
ads_response=$(curl -s https://ads.bt.sy/ads)
